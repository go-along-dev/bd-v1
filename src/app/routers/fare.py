...
async def calculate_fare(
    ...
    # 3. Check if min fare was applied
    fuel_cost        = result["fuel_cost"]
    cost_with_margin = fuel_cost * (
        1 + result["platform_margin_pct"] / Decimal("100")
    )
...
async def calculate_partial_fare(
    ...
    Proportional to passenger's distance vs full ride distance.
    """
    # 1. Fetch ride
